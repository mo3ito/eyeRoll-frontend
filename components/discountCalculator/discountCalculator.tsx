...
<p className='inline-block'>discount calculator</p>
        ...
        <InputDefault value={enterAmount} onChange={changeEnterAmountHandler} type="text" className='w-full h-10 border border-indigo-300 bg-transparent rounded-lg outline-none px-2'/>
        </div>
