...
export default function ShowPresenceUser({setIsShowModalCalculator , setIsShowCancelModal}) {
  return (
    ...
    <p className="text-sm sm:text-lg text-zinc-600 font-semibold  md:w-64 truncate ">mostafaffffffff</p>
    </div>
