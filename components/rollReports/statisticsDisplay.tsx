...
export default function StatisticsDisplay() {
  return (
    ...
    <>
    <div className=' max-xs:w-full w-44   lg:w-56 xl:w-72 xl:h-[360px]  bg-indigo-100 cursor-pointer rounded-2xl hover:scale-105 duration-200 flex items-center justify-around  flex-col py-10 px-4'>
    ...
    <div className=' max-xs:w-full w-44   lg:w-56 xl:w-72 xl:h-[360px]  bg-indigo-100 cursor-pointer rounded-2xl hover:scale-105 duration-200 flex items-center justify-around  flex-col py-10 px-4'>coming soon</div>
    <div className=' max-xs:w-full w-44   lg:w-56 xl:w-72 xl:h-[360px]  bg-indigo-100 cursor-pointer rounded-2xl hover:scale-105 duration-200 flex items-center justify-around  flex-col py-10 px-4'>coming soon</div>
    <div className=' max-xs:w-full w-44   lg:w-56 xl:w-72 xl:h-[360px]  bg-indigo-100 cursor-pointer rounded-2xl hover:scale-105 duration-200 flex items-center justify-around  flex-col py-10 px-4'>coming soon</div>
