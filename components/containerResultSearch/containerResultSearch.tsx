...
<div className='w-full relative'>
    ...
    <li onClick={()=>linkHandler(`/eyeRoll-user/${item._id}`,router)}  key={item._id} className='w-full px-1 md:px-2  max-xs:h-7 h-10 md:h-12 max-xs:pt-1 pt-[10px]   hover:bg-blue-200 hover:opacity-100 overflow-hidden  cursor-pointer opacity-70 truncate'>
