...
export default function RightMenu({showAside , setShowAside , rightMenuRef } : RightMenuProps) {
  ...
  return (
    <div ref={rightMenuRef} className={`${showAside ? 'right-0': '-right-64'} w-64  h-screen sm:hidden  bg-gray-100 border-2 border-indigo-200 absolute top-0  rounded-l-3xl shadow-lg transition-all z-50  overflow-y-auto`}>
