...
export default function MoblilMode() {
  ...
  return (
    ...
    <div onClick={()=>setShowProfile(prev=> !prev)} className='w-12 mt-4 h-12 rounded-full flex items-center justify-center  bg-indigo-300 '>
    <img src="/images/defaultPerson.png" alt="" />
    </div>
    <div ref={profileRef} className={`${ showProfile ? 'absolute' : 'hidden'} w-36 h-max bg-blue-100 absolute text-base z-50 shadow-md border border-purple-500 rounded-md`}>
