...
export default function EditMenuScreen({allProducts , descriptionHandler , processEditHandler , processDeleteHandler }) {
  return (
    <>
    
     {allProducts && allProducts.length > 0 && <div className=" hidden md:flex text-center h-16 w-full font-semibold pt-4">
