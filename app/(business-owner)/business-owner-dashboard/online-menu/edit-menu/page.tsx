...
export default function EditMenu() {
  return (
    <div className="w-full h-screen bg-sky-100 px-8 py-10">
      ...
      <div className='w-full h-10 mb-10'>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex border border-fuchsia-300 bg-pink-100 text-center items-center h-max py-4 max-h-max w-full rounded-lg mb-4">
          <div className="w-1/6 break-words  p-2  mx-3">1</div>
            <div className="w-1/6 break-words  p-2  mx-3">
              sperco
            </div>
            <div className="w-1/6 break-words  p-2  mx-3">hot drink</div>
            <div className="w-1/6 break-words  p-2  mx-3">7 $</div>
            <div className="w-1/6 break-words  p-2  mx-3">
          ...
          <div className="flex border border-fuchsia-300 bg-pink-100 text-center items-center h-max py-4 max-h-max w-full rounded-lg">
          <div className="w-1/6 break-words  p-2  mx-3">1</div>
            <div className="w-1/6 break-words  p-2  mx-3">
              sperco
            </div>
