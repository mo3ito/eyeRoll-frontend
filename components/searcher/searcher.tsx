...
export default function Searcher({items , setAllItems }: SearcherProps) {
  ...
  //   <div className='container h-max top-32 fixed bg-red-200 mx-6'>
  //       <div className="flex flex-col h-max gap-y-10 items-center w-full container   md:mb-0  py-2 mx-auto    ">
