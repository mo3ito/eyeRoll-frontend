...
export default function ContainerOnlineMenu({sortedProduct = [] , setIsShowProduct , setProductDetails}: ContainerOnlineMenuProps) {
 ...
 {sortedProduct.map((item : sortedProduct) =>
           ...
           <div className='w-full  h-max flex justify-around flex-wrap gap-x-2 gap-y-3 sm:gap-y-8 pt-4'>
           ...
           {item.values.map((product : ProductType) =>
               ...
               className=' cursor-pointer w-full sm:w-[280px] md:w-[350px] lg:w-[470px] xl:w-[400px] 2xl:w-[480px] h-28 md:h-32 lg:h-44 xl:h-40 2xl:h-44 border border-fuchsia-400 rounded-lg p-2 flex bg-indigo-50'>
