...
export default function Logo({ className, href = "/" }: LogoProps) {
  return (
    <Link href={href} className={className}>
      <svg
        className="fill-indigo-600 w-14 sm:w-16 "
        version="1.1"
        id="Layer_1"
      ...
      >
        <g>
          <path
            className="st0"
            d="M172.35,50.99c0,0-17.59-17.42-17.6-17.42C139.1,17.29,117.81,6.38,95.27,4
      ...
      <p className="text-xs sm:text-base text-indigo-600 text-center">
        Eye Roll
      </p>
    </Link>
  );
