  ...
  return(
    ...
    <div className="container px-4  h-max mx-auto">
      <form autoComplete="off" onSubmit={submitHandler}>
        ...
        <h2 className="mb-12 text-center text-lg font-semibold">register as customer</h2>
   ...
   <Link href="/register-user/login"  className="text-fuchsia-500 underline text-xl">login</Link>
   </div>
