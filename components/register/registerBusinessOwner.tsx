...
const RegisterBusinessOwner = () => {
    ...
    const submitHandler = async (event : FormEvent<HTMLFormElement>)=>{
      ...
      const goToRegisterHandler  = () : void =>{
        setIsLogin(false)
      }

  return (
    <>
    {isLogin ? <Login onClick={goToRegisterHandler} /> : <form onSubmit={submitHandler} className="w-screen h-screen flex items-center justify-center flex-col overflow-x-hidden ">
