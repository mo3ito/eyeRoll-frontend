...
export default function DeterminationRoll({isShowModal , setIsShowModal }) {
  ...
  return (
  <ModalDefault closeIconClassName="w-8 h-8 fill-red-400" isShowModal={isShowModal} setIsShowModal={setIsShowModal} >
 
   <div className='w-full h-max p-2 overflow-x-hidden sm:text-lg text-zinc-500 flex items-center justify-center'>

    <div className='bg-red-200 w-max h-max'>
    <svg className='fill-indigo-600 w-80 h-80  relative' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
...
<g>
	...
	<path  d="M87.53,20.63
      ...
      <div className='w-36 h-36 rounded-full bg-blue-400  flex justify-center items-center absolute top-[80px]'>
      <div className='w-1/5 bg-red-200'>1</div>
      <div className='w-1/5 bg-red-200'>2</div>
      <div className='w-1/5 bg-red-200'>3</div>
      <div className='w-1/5 bg-red-200'>4</div>
      <div className='w-1/5 bg-red-200'>5</div>
