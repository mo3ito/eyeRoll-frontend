...
<p className='inline-block text-xl'>discount calculator</p>
</div>



        <div className='h-max w-6/12 my-4 text-center'>
        ...
        <InputDefault disabled={false} value={enterAmount} onChange={changeEnterAmountHandler} type="text" className='w-full h-14 text-xl border border-indigo-400 bg-transparent rounded-lg outline-none px-2'/>
        </div>

        <div className=' border border-indigo-400 h-28 w-6/12 text-center py-5 rounded-lg'>
        ...
        <p className='inline-block pr-2 text-xl'>amount of discount:</p>
        <span className='block text-4xl text-orange-300 '>4%</span>
        </div>
       <div className='w-6/12 my-2 h-14'>
       <ButtonDefault onClick={computHandler} className=' w-full text-white hoverScale font-semibold h-full bg-green-400 rounded-lg' text='confirm' />
       </div>
       <div className='w-6/12 border rounded-lg text-center py-2 border-indigo-400'>
