  ...
  return (
    ...
    <div className='w-full  h-max py-8 block mt-16 lg:hidden'>
      { allProducts && allProducts.map((product: ProductsType , index : number)=>
        ...
        <div  className='h-max pt-1 px-2 break-words'>image: <span className='inline-block '><img className='w-5 h-5 translate-y-1 object-cover' src={product.product_image_path ? product.product_image_path : "/images/default-product.jpg"} alt="" /> </span></div>
