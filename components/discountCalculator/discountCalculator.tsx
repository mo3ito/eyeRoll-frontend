...
<p className='inline-block text-lg sm:text-xl'>discount calculator</p>
        ...
        <div className='h-max w-full sm:w-7/12 my-4 text-center bg-red-200'>
        ...
        <div className=' border border-indigo-400 w-full h-max sm:w-7/12 text-center py-5 rounded-lg'>
       ...
       <div className=' w-full sm:w-7/12 my-2 h-14'>
       ...
       <div className=' w-full sm:w-7/12 border rounded-lg text-center py-2 border-indigo-400'>
